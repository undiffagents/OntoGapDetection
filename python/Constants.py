...
CONST_ITEM_AFFORDANCE_NODE = 'Affordance'
...
CONST_ITEM_ROLE_TYPE_NODE = 'ItemRoleType'
CONST_ITEM_ROLE_TYPE_EDGE = 'ofItemRoleType'
CONST_ITEM_ROLE_TYPE_NAME_NODE = 'ItemRoleTypeName'
CONST_HAS_NAME_EDGE = 'hasName'

CONST_ITEM_HAS_NAME_EDGE = 'hasItemName'
CONST_ITEM_HAS_AFFORDANCE_EDGE = 'affords'
CONST_ROLE_ASSUMED_BY = 'assumedBy'
CONST_ITEM_HAS_DESCRIPTION_EDGE = 'ItemHasDescription'
CONST_DESCRIPTION_OF_ITEM = 'ofItem'
CONST_ITEM_HAS_ROLE_EDGE = 'ItemHasRole'
CONST_ITEM_HAS_OP_EDGE = 'ItemHasOp'
CONST_ITEM_HAS_COUNT_EDGE = 'ItemHasCount'

CONST_ITEM_LOCATION_NODE = 'Location'
CONST_ITEM_COLOR_NODE = 'Color'
CONST_ITEM_SHAPE_NODE = 'Shape'
CONST_ITEM_TYPE_NODE = 'Type'

CONST_REFERS_TO_ITEM_LOCATION_EDGE = 'refersToItemLocation'
CONST_REFERS_TO_ITEM_COLOR_EDGE = 'refersToItemColor'
CONST_REFERS_TO_ITEM_SHAPE_EDGE = 'refersToItemShape'
CONST_REFERS_TO_ITEM_TYPE_EDGE = 'refersToItemType'
