...
Integrated custom datalog reasoner for APE parsed instructions, to check for rule coverage *gaps* after running. Works but is repurposed from the link above. Will modify to suit this task at a later time.
